...
var HIKKA, MAX_PERIOD, SMALL_PERIOD, addMoment, bhToString, calculateBhLevel, logger, misc, newStats, randomHikka, removeOldMoments, smiles;
...
module.exports = {
  ...
  handleStatus: function(msg) {
    var base, bhLevel, now, stats, userId;
    userId = msg.from.id;
    stats = (base = this.stats)[userId] != null ? base[userId] : base[userId] = newStats(userId);

...
var MOON, QUOTE_MERGE_TIMEOUT, TOP_AUTHORS, _getByOwnerId, fn, fromMsg, fs, getByNumber, getLastNum, getNextNum, getRating, getSenders, getUserNameById, hasSender, hasText, initialized, lastMsg, lastQuote, lastUsersUpdate, loadVotes, logger, maybeSaveVotes, misc, msgCache, quotes, saveQuotes, saveVotes, saveVotesTimer, votes;
...
exports.getRandom = function(arg) {
  var onlyPositive, q, qq;
  onlyPositive = arg.onlyPositive;
  if (onlyPositive) {
    qq = (function() {
      var l, len1, results;
      results = [];
